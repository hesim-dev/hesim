...
\end{aligned}
$$
Equivalently, (if $c_{g1} - c_{g0} >0$ and $e_{g1} - e_{g0} >0$), treatment $1$ is preferred to treatment $0$ in subgroup $g$ if the incremental cost-effectiveness ratio (ICER) is greater than the willingness to pay threshold $k$,
