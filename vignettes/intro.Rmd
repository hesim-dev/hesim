...
# Overview
This vignette provides an overview of the `hesim` package and a quick example. The other vignettes provide a number of more in depth examples.
...
library("ggplot2")
ggplot(cea_pw_out$ceac, aes(x = k, y = prob, col = factor(strategy_id))) +
