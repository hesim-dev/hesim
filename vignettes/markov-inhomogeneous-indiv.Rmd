...
# Decision analysis
Since we performed a PSA, decision uncertainty could be formally quantified. Since we cover that in [other vignettes](cea.html), we will simply compute the incremental cost-effectiveness ratio (ICER) here. 
