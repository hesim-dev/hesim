...
where $e$ is a measure of clinical effectiveness (e.g. QALYs), $w$ is the value or willingess to pay per unit of effectiveness, and c is costs. Decision makers are generally concerned with expected outcomes, so $e$ and $c$ are usually averages (rather than say medians). Separate treatment decision can be made for each patient or for subgroups of patients, although it is most common for decisions to be made uniformly for all patients. 
