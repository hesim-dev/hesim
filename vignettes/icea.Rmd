...
```{r mce_example_setup, echo = -1, message = FALSE}
library("knitr")
...
```{r ceplane_plot}
head(icea_pw_dt$delta)
ylim <- max(icea_pw_dt$delta[, ic]) * 1.1
