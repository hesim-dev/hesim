---
title: Getting started with a Markov cohort model
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: yes
...
pkgdown:
  as_is: true
vignette: >
  %\VignetteIndexEntry{Getting started with a Markov Cohort Model}
...
The model will be simulated for each treatment strategy and patient combination. Such data containing treatment strategy and patient characteristics can be generated using `expand()`. 
...
Tbe parameter estimates are stored in a list.
