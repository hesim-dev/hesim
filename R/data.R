...
#' \item{Costs}{ A list of data frames. The first element is a data frame containing medical cost data and the
#' second element is a data frame containing drug cost data.}
#' }
#' 
