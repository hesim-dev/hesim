 ...
 *	Func fun; Name of the function whose zero
 *					will be seeked for
...
inline double zeroin(			/* An estimate of the root */
    double ax,				/* Left border | of the range	*/
    double bx,				/* Right border| the root is seeked*/
    double fa, double fb,		/* f(a), f(b) */
    Func fun,	/* Function under investigation	*/
    ...
    int *Maxit)				/* Max # of iterations */
{
	...
	*Maxit = 0;
	...
	if( fabs(prev_step) >= tol_act	/* If prev_step was large enough*/
	    ...
	    double t1,cb,t2; // register is deprecated in c++ 11
	    cb = c-b;
	...
	b += new_step;	fb = fun(b);	/* Do step to a new approxim. */
