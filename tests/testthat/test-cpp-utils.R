...
test_that("add_constant", {
  ...
  v2 <- c(1.2, 4, 5.6)
  expect_equal(
    hesim:::C_test_add_constant_int(v1, 5.5),
    floor(v1 + 5.5)
  )
  expect_equal(
    hesim:::C_test_add_constant_double(v2, 5.5),
    v2 + 5.5
  )
})
...
test_that("pv", {
  expect_equal(
    hesim:::C_test_pv(1, 0, 0, 4),
    4
  )
  expect_equal(
    hesim:::C_test_pv(2, .03, 1, 4),
...
test_that("seq", {
  expect_equal(
    hesim:::C_test_seq(0, 3.01, .1),
    seq(0, 3, .1)
  )
  expect_equal(
    hesim:::C_test_seq(0, 2.9, .2),
    seq(0, 2.9, .2)
  )
  expect_equal(
    hesim:::C_test_seq(0, -3.01, -.1),
