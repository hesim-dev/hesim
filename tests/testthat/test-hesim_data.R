...
test_that(paste0(
  "create_trans_dt() does not create '_name' columns without both ",
...
test_that("id_attributes() throws error if length of ID vectors is wrong ", {
  expect_error(
    ...
    paste0(
      "The length of the ID variables is not consistent with the number of ",
...
test_that("id_attributes() throws error if there are not the right sizes within groups ", {
  ...
  expect_error(
    ...
    paste0(
      "The number of unique patient_id observations within each strategy_id ",
  ...
  expect_error(
    ...
    paste0(
      "The number of unique state_id observations within each strategy_id ",
